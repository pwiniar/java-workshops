 ...
 */
public class OpenExchangeRatesOrg implements CurrencyRepository {
    ...
    public OpenExchangeRatesOrg(String appId) {
        this.appId = appId;
    }

    private Map<String, BigDecimal> updateExchangeRates(String downloadPath) throws UnavailableExchangeRateException {
    ...
    public Map<String, BigDecimal> historical(Calendar date) throws UnavailableExchangeRateException {
    ...
    public BigDecimal historicalCurrency(String currency, Calendar date) throws UnavailableExchangeRateException {
        return historical(date).get(currency);
    }

    @Override
    public BigDecimal getCurrency(Currency currency, Date date) throws UnavailableExchangeRateException {
